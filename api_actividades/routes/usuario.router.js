...
const {createSchema, updateSchema, getSchema} = require('../schemas/usuario.schema');
const secure  = require('../../middlewares/secure.handler');
...
router.patch('/:id', validatorHandler(updateSchema, 'body'), secure('update'), updatePatch);
